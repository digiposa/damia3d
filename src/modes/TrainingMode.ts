...
export abstract class ArenaCombatMode extends GameMode {
  ...
  /** Spawn a Forest minor enemy — Berserk Mouse (non-humanoid, procedural animation). */
  ...
  /** Spawn a Forest minor enemy — Trent (non-humanoid, procedural animation). */
  private async spawnTrent(): Promise<void> {
