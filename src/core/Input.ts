...
export class Input {
  ...
  /**
   * Movement axis on the ground plane, normalized to length <= 1. Driven solely by the
   * virtual (touch) joystick — desktop uses click-to-move (Diablo-style), so no keyboard
   * movement keys are read here.
   */
