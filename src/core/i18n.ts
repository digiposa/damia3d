...
const en: Dict = {
  ...
  "mode.survival.blurb": "Endless enemy waves",
  ...
  "item.sunRhapsody": "Sun Rhapsody",
  "item.burnOut": "Burn Out",
  "item.gushingMagma": "Gushing Magma",
  "item.burningWave": "Burning Wave",
  "item.pellet": "Pellet",
  "item.meteorFall": "Meteor Fall",
  "item.gravityGrabber": "Gravity Grabber",
  "item.sparkNet": "Spark Net",
  "item.thunderbolt": "Thunderbolt",
  "item.flashHall": "Flash Hall",
  "item.spinningGale": "Spinning Gale",
  "item.raveTwister": "Rave Twister",
  "item.downBurst": "Down Burst",
  "item.spearFrost": "Spear Frost",
  "item.fatalBlizzard": "Fatal Blizzard",
  "item.frozenJet": "Frozen Jet",
  "item.darkMist": "Dark Mist",
  "item.blackRain": "Black Rain",
  "item.nightRaid": "Night Raid",
  "item.transLight": "Trans Light",
  "item.dancingRay": "Dancing Ray",
  "item.spectralFlash": "Spectral Flash",
  "item.detonateRock": "Detonate Rock",
  "item.psychedelicBomb": "Psychedelic Bomb",
  "item.psychedelicBombX": "Psychedelic Bomb X",
  ...
  "combat.mash": "MASH X!",
  "combat.mashTap": "TAP!",
  "survival.selectTitle": "Choose your character",
  "survival.selectHint": "Tap up to 3 — the first is your leader (★)",
  "survival.selectSoloHint": "You start solo — recruit allies as rare rewards",
  "training.selectSoloHint": "You start solo — add or kick members from the menu (Party tab)",
  "survival.selectEmpty": "Pick a character",
  "survival.start": "Start",
  "survival.recruited": "{name} joined!",
  "survival.dragoonReward": "{name} — Dragoon Spirit!",
  "survival.levelUp": "LEVEL {n} — CHOOSE A REWARD",
  "reward.recruit": "Recruit {name}",
  "reward.recruitDesc": "{name} joins your party",
  "reward.dragoon": "Dragoon Spirit",
  "reward.dragoonDesc": "{name} can now transform",
  "reward.heal": "Second Wind",
  "reward.healDesc": "Fully heal the whole party",
  "reward.potions": "Supply Cache",
  "reward.potionsDesc": "+3 Healing Potions",
  "reward.atk": "Power +{n}",
  "reward.atkDesc": "+{n} Attack for the whole party",
  "reward.def": "Guard +{n}",
  "reward.defDesc": "+{n} Defense for the whole party",
  "reward.mat": "Focus +{n}",
  "reward.matDesc": "+{n} Magic Attack for the whole party",
  "reward.hp": "Vitality +{n}",
  "reward.hpDesc": "+{n} Max HP for the whole party",
  "survival.wave": "WAVE {n}",
  "survival.miniBoss": "WAVE {n} — MINI-BOSS",
  "survival.bossLoot": "BOSS DOWN — CLAIM YOUR LOOT",
  "survival.looted": "Looted: {name}",
  "survival.gameOver": "GAME OVER",
  "survival.wavesSurvived": "Waves survived: {n}",
  "survival.kills": "Kills: {n}",
  "survival.best": "Best: {n}",
  "survival.newBest": "NEW BEST!",
  "survival.retry": "Retry",
  "survival.quit": "Main menu",
...
const fr: Dict = {
  ...
  "item.sunRhapsody": "Rhapsodie du Soleil",
  "item.burnOut": "Burn Out",
  "item.gushingMagma": "Gushing Magma",
  "item.burningWave": "Burning Wave",
  "item.pellet": "Pellet",
  ...
  "debug.level": "Niveau",
  "debug.dragoonLevel": "Niveau Dragoon",
  ...
  "combat.mash": "MARTELEZ X !",
  "combat.mashTap": "TAPEZ !",
  "survival.selectTitle": "Choisis ton perso",
  "survival.selectHint": "Choisis jusqu'à 3 — le premier est ton leader (★)",
  "survival.selectSoloHint": "Tu commences seul — recrute des alliés en récompenses rares",
  "training.selectSoloHint": "Tu commences seul — ajoute ou retire des membres via le menu (onglet Équipe)",
  "survival.selectEmpty": "Choisis un perso",
  "survival.start": "Commencer",
  "survival.recruited": "{name} rejoint l'équipe !",
  "survival.dragoonReward": "{name} — Esprit Dragoon !",
  "survival.levelUp": "NIVEAU {n} — CHOISIS UNE RÉCOMPENSE",
  "reward.recruit": "Recruter {name}",
  "reward.recruitDesc": "{name} rejoint ton équipe",
  "reward.dragoon": "Esprit Dragoon",
  "reward.dragoonDesc": "{name} peut se transformer",
  "reward.heal": "Second souffle",
  "reward.healDesc": "Soigne toute l'équipe à fond",
  "reward.potions": "Réserve de potions",
  "reward.potionsDesc": "+3 Potions de soin",
  "reward.atk": "Puissance +{n}",
  "reward.atkDesc": "+{n} Attaque pour toute l'équipe",
  "reward.def": "Garde +{n}",
  "reward.defDesc": "+{n} Défense pour toute l'équipe",
  "reward.mat": "Focus +{n}",
  "reward.matDesc": "+{n} Attaque magique pour toute l'équipe",
  "reward.hp": "Vitalité +{n}",
  "reward.hpDesc": "+{n} PV max pour toute l'équipe",
  "survival.wave": "VAGUE {n}",
  "survival.miniBoss": "VAGUE {n} — MINI-BOSS",
  "survival.bossLoot": "BOSS VAINCU — RÉCUPÈRE TON BUTIN",
  "survival.looted": "Butin : {name}",
  "survival.gameOver": "PARTIE TERMINÉE",
  "survival.wavesSurvived": "Vagues tenues : {n}",
  "survival.kills": "Éliminations : {n}",
  "survival.best": "Record : {n}",
  "survival.newBest": "NOUVEAU RECORD !",
  "survival.retry": "Rejouer",
  "survival.quit": "Menu principal",
