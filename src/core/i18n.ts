...
const en: Dict = {
  ...
  "combat.mash": "MASH X!",
  "combat.mashTap": "TAP!",
  "survival.selectTitle": "Choose your party",
  "survival.selectHint": "Tap up to 3 — the first is your leader (★)",
  "survival.selectEmpty": "Pick at least one",
...
const fr: Dict = {
  ...
  "survival.selectTitle": "Choisis ton équipe",
  "survival.selectHint": "Choisis jusqu'à 3 — le premier est ton leader (★)",
  "survival.selectEmpty": "Choisis au moins un perso",
