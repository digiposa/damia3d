...
export const EQUIPMENT: EquipDef[] = [
  ...
  { id: "jeweled_crown", name: "Jeweled Crown", slot: "head", mat: 42, mdf: 5, users: ["Shana", "Miranda", "Meru"], price: 200, effect: "When magically damaged, gain 20 SP." },
  ...
  // Haschel
  { id: "disciple_vest", name: "Disciple Vest", slot: "body", df: 13, mdf: 8, aAv: 10, users: ["Haschel"] },
  { id: "warrior_dress", name: "Warrior Dress", slot: "body", df: 25, mdf: 23, aAv: 20, users: ["Haschel"], price: 150 },
  { id: "masters_vest", name: "Master's Vest", slot: "body", df: 30, mdf: 29, aAv: 10, users: ["Haschel"], price: 250, effect: "When physically damaged, gain 20 SP." },
  { id: "energy_girdle", name: "Energy Girdle", slot: "body", df: 37, mdf: 26, aAv: 10, users: ["Haschel"], price: 300, effect: "Additions accrue 50% more Spirit Points." },
  { id: "satori_vest", name: "Satori Vest", slot: "body", df: 40, mdf: 31, aAv: 10, users: ["Haschel"], effect: "Prevents Poison, Stun and Arm-Blocking." },
  ...
  { id: "breast_plate", name: "Breast Plate", slot: "body", df: 59, mdf: 14, users: ["Kongol"], price: 250 },
  { id: "giganto_armor", name: "Giganto Armor", slot: "body", df: 75, mdf: 26, users: ["Kongol"], price: 400, effect: "When physically damaged, gain 20 SP." },
  { id: "gold_dg_armor", name: "Gold DG Armor", slot: "body", df: 88, mdf: 23, users: ["Kongol"], price: 800, effect: "Reduces Earth-elemental magic damage to 0." },
  // Female
  { id: "clothes", name: "Clothes", slot: "body", df: 4, mdf: 5, aAv: 5, mAv: 5, users: WOMEN },
  { id: "leather_jacket", name: "Leather Jacket", slot: "body", df: 7, mdf: 12, aAv: 5, mAv: 5, users: ["Shana", "Miranda", "Rose"], price: 50 },
  { id: "angel_robe", name: "Angel Robe", slot: "body", df: 10, mdf: 20, aAv: 5, mAv: 5, users: ["Shana", "Miranda", "Meru"], price: 500, effect: "~45% chance to revive with half HP on KO." },
  { id: "silver_vest", name: "Silver Vest", slot: "body", df: 13, mdf: 27, aAv: 10, mAv: 5, users: WOMEN, price: 150 },
  { id: "sparkle_dress", name: "Sparkle Dress", slot: "body", df: 19, mdf: 45, aAv: 5, mAv: 5, users: WOMEN, price: 200, effect: "When physically damaged, gain 20 SP." },
  { id: "robe", name: "Robe", slot: "body", df: 25, mdf: 35, aAv: 5, mAv: 5, users: WOMEN, price: 500, effect: "When magically damaged, gain 20 SP." },
  { id: "rainbow_dress", name: "Rainbow Dress", slot: "body", df: 32, mdf: 55, aAv: 5, mAv: 5, users: WOMEN, effect: "Prevents Poison, Stun and Arm-Blocking." },
  { id: "blue_dg_armor", name: "Blue DG Armor", slot: "body", df: 30, mdf: 54, aAv: 5, mAv: 5, users: ["Meru"], price: 800, effect: "Reduces Water-elemental magic damage to 0." },
  { id: "dark_dg_armor", name: "Dark DG Armor", slot: "body", df: 41, mdf: 42, aAv: 5, mAv: 5, users: ["Rose"], price: 800, effect: "Reduces Darkness-elemental magic damage to 0." },
  { id: "silver_dg_armor", name: "Silver DG Armor", slot: "body", df: 27, mdf: 80, aAv: 5, mAv: 5, users: ["Shana", "Miranda"], price: 800, effect: "Reduces Light-elemental magic damage to 0." },
  // All
  ...
  { id: "holy_ahnk", name: "Holy Ahnk", slot: "accessory", effect: "~45% chance to revive with half HP on KO." },
