# Gehrich — Wiki LoD Verbatim Source

> **Source** : The Legend of Dragoon Wiki (tier 2 🥈)
> **Date d'ingestion** : 2026-05-27
> **Page** : Gehrich
...
> File:Boss Gehrich.webp

| Element | Counters Additions? |
| ------- | ------------------- |
| Earth   | **Yes**             |
...
### Status Immunity (8/8 ALL IMMUNE — boss-tier)
...
| EXP   | Gold | Drops             |
| ----- | ---- | ----------------- |
| 5,000 | 200  | Soul Headband 25% |

### Counterattack Opportunities (28)
...
| ------------------------ | ------------------------- | ------------ | ------- |
| **Gehrich, Mappi** (403) | **Home of Giganto** (266) | **Scripted** | **0%**  |
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| **Retaliate** | **Ignore turn order and use Knife Slash (if Requirements met), 3-step Kick, or Team Up with Mappi (if Requirements met)** | **Chance to trigger when targeted by an attack** |
...
| ----------------------- | ------ | --------------------------------- | --------------------------------------------------------------------- |
| **~Knife Slash**        | Single | Inflicts **1× Physical damage**   | **Only used while Mappi is not in battle or has Untargetable**        |
| **~3-step Kick**        | Single | Inflicts **1.5× Physical damage** | -                                                                     |
| **~Team Up with Mappi** | Single | Inflicts **2× Physical damage**   | **Only used while Mappi is in battle and does not have Untargetable** |
...
**Categories** : Pages with broken file links, Missing Information, Bosses, **Disc 2**
